  ...
  var dataGrid;
	...
	jQuery(function($){
		dataGrid = $('#dataGrid').datagrid({
			...
			columns:[[
				...
				{field:'coreCpId',title:'核心企业ID',width:80,sortable:true},
				{field:'coreCpIdName',title:'核心企业名称',width:180,sortable:true},
				{field:'loanCpId',title:'融资企业ID',width:80,sortable:true},
				{field:'loanCpName',title:'融资企业名称',width:100,sortable:true},
				{field:'bank',title:'银行',width:100,sortable:true},
				{field:'amount',title:'融资金额',width:100,sortable:true},
	...
	function addFun() {
		parent.$.modalDialog({
			...
			width : 500,
			height : 200,
			href : '${ctx}/loan/loanSave.do',
			buttons : [ {
				text : '添加贷款申请',
				handler : function() {
					parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个treeGrid，所以先预定义好
					var f = parent.$.modalDialog.handler.find('#loanAddForm');
					f.submit();
				}
			} ]
		});
	...
	<div id="toolbar" style="display: none;">
		<c:if test="${fn:contains(sessionInfo.resourceList, '/loan/add.do')}">
